...
name_signs_cnn = {
    ...
    "krug": ["3.2", "3.34", "3.18.2", "3.13", "3.20.1", "3.4", "empty", "3.18.1", "3.9", "3.5"],
    "red": ["2.5","3.1"],
    "treugolnik": ["1.21", "1.29", "empty", "1.17", "1.29", "1.20", "1.32", "1.5", "1.1", "1.23"],
    "servises": ["5.16", "7.1", "7.11", "7.18", "7.2", "5.14.2", "7.15", "7.7", "6.12.2", "7.5", "7.3", "7.16", "7.4"],
    "tablichka __" : ["8.12", "8.3.1", "8.2.6", "8.2.1", "8.3.2", "8.5.7", "8.1.3", "7.14.1", "8.1.1", "8.15", "8.8", "8.10" ],
